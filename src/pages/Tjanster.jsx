...
const Tjanster = () => {
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-framewave-darkblue mb-8">Våra Tjänster</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-framewave-paleblue p-6 rounded-lg">
          <h2 className="text-2xl font-semibold text-framewave-blue mb-4">Videoproduktion</h2>
        ...
        <div className="bg-framewave-paleblue p-6 rounded-lg">
          <h2 className="text-2xl font-semibold text-framewave-blue mb-4">Fotografi</h2>
          <ul className="list-disc list-inside space-y-2">
